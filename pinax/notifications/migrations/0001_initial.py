...
# IF THIS FILE SHOWS UP IN A MERGE CONFLICT, IT SHOULD STAY AS THE ARTISTGROWTH MODIFIED VERSION
# except to maintain django compatibility to add newly required kwargs
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='notice_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, verbose_name='notice type', to='pinax_notifications.NoticeType'),
        ),
        migrations.AddField(
            model_name='noticesetting',
            name='user',
